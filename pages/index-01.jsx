            ...
            <div className="row full-screen align-items-center p-100px-tb">
              <div className="col-md-6">
                <div className="ht-text">
                  ...
                  <p>
                  Passionate React Native developer dedicated to crafting user-friendly mobile applications that positively impact people's lives through innovative concepts.
                  </p>
